                                ...
                                <Col>
                                    ...
                                    <UncontrolledDropdown className="d-inline">
                                        <DropdownToggle tag="a" className="dropdown-toggle p-0 arrow-none font-weight-bold cursor-pointer">
                                            Capital-Luxury Design
                                            <i className='uil uil-angle-down font-size-16 align-middle ml-1'></i>
                                        </DropdownToggle>
                                        <DropdownMenu>
                                            <DropdownItem>
                                                <HardDrive className="icon-dual icon-xs mr-2"></HardDrive>Capital-Luxury Design
                                            </DropdownItem>
                                            <DropdownItem>
                                            ...
                                            <DropdownItem divider />
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Capital-Luxury Angular
                                            </DropdownItem>
                                            <DropdownItem>
                                                <FolderPlus className="icon-dual icon-xs mr-2" data-feather="briefcase"></FolderPlus>Capital-Luxury React
                                            </DropdownItem>
                                        </DropdownMenu>
                                    </UncontrolledDropdown>
                                </Col>
