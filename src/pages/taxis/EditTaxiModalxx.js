...
class EditTaxiVehicleTypeModal extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                <Col xl={12}>
                    <div className="button-list">
                        <Button className='btn btn-primary' onClick={this.toggle}>Edit Taxi</Button>
                    </div>
                </Col>
                {/* Start Modal */}
                <Modal
...
export default EditTaxiVehicleTypeModal;