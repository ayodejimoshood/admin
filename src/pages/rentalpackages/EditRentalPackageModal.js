...
class EditRentalPackageModal extends Component {
    constructor(props) {
        super(props);
        ...
        return (
            <div>
                ...
                <Modal
                    ...
                    <ModalHeader toggle={this.toggle}>Edit Rental Package</ModalHeader>
                    <ModalBody>
                        <AvForm>
                            <AvField value="Basic" name="vehicletype" label="Vehicle Type" type="text" required />
                            <AvField value="Taxi" name="vehiclecategory" label="Vehicle Category" type="text" required />
                            <AvField value="6" name="rentalpackage" label="Rental Package" type="text" required />
...
export default EditRentalPackageModal;