...
class AddRentalPackageModal extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                <Col xl={12}>
                    <div className="button-list">
                        <Button className='btn btn-primary' onClick={this.toggle}>Add Rental Package</Button>
                    </div>
                </Col>
                {/* Start Modal */}
                <Modal
                    ...
                    <ModalHeader toggle={this.toggle}>Add Rental Package</ModalHeader>
                    <ModalBody>
                        <AvForm>
                            <AvField name="vehicletype" label="Vehicle Type" type="text" required />
                            <AvField name="vehiclecategory" label="Vehicle Category" type="text" required />
                            <AvField name="rentalpackage" label="Rental Package" type="text" required />
...
export default AddRentalPackageModal;