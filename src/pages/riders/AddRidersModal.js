...
class AddRidersModal extends Component {
    constructor(props) {
        super(props);
            ...
            <div>
                <Col xl={12}>
                    <div className="button-list">
                        <Button className='btn btn-primary' onClick={() => this.openModalWithSize('lg')}>Add Rider</Button>
                    </div>
                </Col>
                {/* Start Modal */}
                <Modal
                    ...
                    <ModalHeader toggle={this.toggle}>Add Rider</ModalHeader>
                    <ModalBody>
