...
class Login extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            username: 'amoshood@fczmedia.com',
            password: 'password'
        }
    }
                    ...
                    <Container>
                        {/* <div className="text-center mb-5">
                            <a href="/">
                                ...
                                <h3 className="d-inline align-middle ml-1 text-logo">CAPITALLUXE</h3>
                            </a>
                        </div> */}
                        <br/>
                        <br/>
                                    ...
                                    <CardBody className="p-0">
                                        <Row>
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                <p className="text-muted mt-1 mb-4">Enter your email address and password to access admin dashboard.</p>
                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="text" name="username" id="username" placeholder="hello@capitalluxurydev.xyz" value={this.state.username} required />
                                                        </InputGroup>
                                                    ...
                                                    <p style={{fontSize: '13px'}} className="mt-3"><strong>Username:</strong> amoshood@fczmedia.com &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>Password:</strong> password</p>
                                                </AvForm>
                                            </Col>
