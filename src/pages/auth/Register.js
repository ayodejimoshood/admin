                                            ...
                                            <Col md={6} className="p-5 position-relative">
                                                ...
                                                <div className="mx-auto mb-5">
                                                    <a href="/">
                                                        ...
                                                        {/* <h3 className="d-inline align-middle ml-1 text-logo">Capital-Luxury</h3> */}
                                                    </a>
                                                </div>
                                                ...
                                                <AvForm onValidSubmit={this.handleValidSubmit} className="authentication-form">
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="text" name="fullname" id="fullname" placeholder="Ayodeji Moshood" required />
                                                        </InputGroup>
                                                    ...
                                                    <AvGroup className="">
                                                        ...
                                                        <InputGroup>
                                                            ...
                                                            <AvInput type="email" name="email" id="email" placeholder="hello@capitalluxurydev.xyz" required />
                                                        </InputGroup>
