...
// rentals
const Rental = React.lazy(() => import('../pages/rentalpackages'));
const LogisticsRentals = React.lazy(() => import('../pages/rentalpackages/logistics'));
const TaxiRentals = React.lazy(() => import('../pages/rentalpackages/taxi'));
// add basic rental packages for taxi
// const ViewRentalPackages = React.lazy(() => import('../pages/rentalpackages/view'));
// const LuxuryRentalPackages = React.lazy(() => import('../pages/rentalpackages/View'));
...
const adminusersRoutes = {
    ...
    //     },
    //     {
    //         path: '/users/traveldispatchusers',
    //         name: 'Travel & Logistics Users',
    //         component: TravelDispatchUsers,
    //         route: PrivateRoute,
    //         roles: ['Admin'],
    //     },
    //     {
...
const appRoutes = [adminusersRoutes, usersRoutes, ridersRoutes, driversRoutes, drivertaxisRoutes, companyRoutes, rentalRoutes, viewrentalRoutes, vehicletypeRoutes, ridelaterbookingsRoutes, tripsRoutes];
// const appRoutes = [adminusersRoutes, usersRoutes, ridersRoutes, driversRoutes, drivertaxisRoutes, companyRoutes, calendarAppRoutes, emailAppRoutes, projectAppRoutes, taskAppRoutes];
